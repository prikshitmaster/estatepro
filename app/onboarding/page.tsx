  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F8FAFC" }}>
      ...
      <header className="h-14 flex items-center px-6" style={{ background: "#1e293b" }}>
        ...
        <span style={{ fontSize: 15, fontWeight: 800, color: "#fff", letterSpacing: "-0.02em" }}>RatePerFeet</span>
      </header>
          ...
          {step === "welcome" && (
            <Card>
              <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to RatePerFeet</h1>
