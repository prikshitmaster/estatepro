// app/_components/Sidebar.tsx — desktop left nav
"use client";
      ...
      <div className="px-2 pb-4 flex flex-col gap-0.5 border-t border-gray-100 pt-3">
        ...
        <div className="flex items-center gap-2.5 px-3 py-2.5 mt-1">
          <div className="w-7 h-7 rounded-full bg-blue-600 flex items-center justify-center shrink-0">
            <span className="text-white text-[11px] font-bold">JP</span>
          </div>
          <div className="min-w-0">
            <p className="text-[12px] font-semibold text-gray-800 truncate">Jay Patel</p>
            <p className="text-[10px] text-gray-400 truncate">Broker</p>
          </div>
        </div>
      </div>
    </aside>
...
function DashboardIcon({ active }: { active: boolean }) {
  return (
    <svg className={`w-4 h-4 shrink-0 ${active ? "text-blue-600" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
