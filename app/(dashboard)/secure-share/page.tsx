...
function LinkRow({
  link, copied, onCopy, onWhatsApp, onLogs, onToggle, onDelete,
}: {
  link: SecureShareLink;
  copied: string | null;
  onCopy: (t: string) => void;
  onWhatsApp: (t: string, title: string) => void;
    ...
    <tr className="hover:bg-[#F8F9FB] transition-colors">
      ...
      <td className="px-5 py-3.5">
        <div className="flex items-center gap-1 justify-end">
          ...
          <ActionBtn title="Share on WhatsApp" onClick={() => onWhatsApp(link.token, link.title)}>
            <WhatsAppIcon />
          </ActionBtn>
  ...
  return (
    <div className="px-4 py-3.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          onClick={() => onWhatsApp(link.token, link.title)}
